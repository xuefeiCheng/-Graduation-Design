...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      echarts3:       [   'libs/echarts/echarts.js'],

      echarts2:       [   'libs/echarts/echarts-2.2.7.min.js'],
      alarmMap:		  [   'libs/echarts/esl.js',
                                'libs/echarts/default.js',
                                'libs/echarts/echarts-map.js']
}
  )
